...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6. Bonus de Tarea");
    ...
    //Bonus
    private static void bonusTarea() {
        Scanner scanner = new Scanner(System.in);
        int numero, mayor = Integer.MIN_VALUE, menor = Integer.MAX_VALUE;

        System.out.println("Ingrese una serie de números enteros (número negativo para terminar):");
